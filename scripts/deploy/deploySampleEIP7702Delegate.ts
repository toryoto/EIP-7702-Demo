...
import { SampleEIP7702Delegation__factory } from "../../typechain-types";
...
async function main() {
  ...
  const delegateFactory = new SampleEIP7702Delegation__factory(deployer);
  ...
  console.log("SampleEIP7702Delegate deployed to:", delegateAddress);
